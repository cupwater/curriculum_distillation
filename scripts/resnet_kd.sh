...
python main_kd.py \
    --temperature $3 --teacher-path experiments/$7/baseline/resnet$4_wd0.0001/model_best.pth.tar --teacher-depth $4 \
    --loss-fun $2 \
    -a $5 --depth $6 --dataset $7 --lr $8 --train-batch 64 --epochs 200 --schedule 80 130 161 --gamma 0.1 --wd 1e-4 \
    --pce-threshold $9 \
    ${10} \
